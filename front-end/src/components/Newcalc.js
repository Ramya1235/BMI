                ...
                <div class="col">
                    <div class="row row-sm-4">
                        <center>
                            ...
                            <input class="" value={name} placeholder="Enter Name" onChange={(e) => setName(e.target.value)} />
                        </center>
                    </div>
                    <div class="row row-sm-4">
                        <center>
                            <label>Height in Cm</label>
                            <input class="" value={height} onChange={(e) => setHeight(e.target.value)} />
                        </center>
                    </div>
                        ...
                        <center>
                            ...
                            <input class="" value={mass} onChange={(e) => setMass(e.target.value)} />
                    </center>
